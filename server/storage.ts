...
class ParticleExplosion {
  ...
  private getFluidWaveCode(): string {
...
class FluidWave {
  ...
  private getMatrixGlitchCode(): string {
...
class MatrixGlitch {
  ...
  private getLightningCode(): string {
...
class LightningStorm {
  ...
  private getShapeMorphCode(): string {
...
class ShapeMorph {
  ...
  private getDigitalFireCode(): string {
