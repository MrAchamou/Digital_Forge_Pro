...
router.post('/health/force-optimization', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(500).json({ error: 'Optimization failed', details: error_1 instanceof Error ? error_1.message : String(error_1) });
                return [3 /*break*/, 3];
...
router.get('/health/emergency-diagnostic', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                res.status(500).json({ error: 'Emergency diagnostic failed', details: error_2 instanceof Error ? error_2.message : String(error_2) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
        ...
        switch (_d.label) {
            ...
            case 8:
                ...
                results.push({
                    fileName: file.originalname,
                    success: false,
                    error: fileError_1 instanceof Error ? fileError_1.message : String(fileError_1)
                });
                return [3 /*break*/, 9];
            case 9:
                _i++;
        ...
        switch (_a.label) {
            ...
            case 6:
                ...
                repairActions.push({
                    ...
                    action: 'failed',
                    success: false,
                    error: repairError_2 instanceof Error ? repairError_2.message : String(repairError_2)
                });
                return [3 /*break*/, 7];
            case 7:
                _i++;
            ...
            switch (_b.label) {
                ...
                case 10:
                    ...
                    return [2 /*return*/, {
                            ...
                            success: false,
                            details: cleanupError_2 instanceof Error ? cleanupError_2.message : String(cleanupError_2)
                        }];
                case 11: return [2 /*return*/, {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    ...
                    return [2 /*return*/, { success: false, reason: repairError_3 instanceof Error ? repairError_3.message : String(repairError_3) }];
...
router.post('/system/optimize', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_9 = _a.sent();
                res.status(500).json({ error: error_9 instanceof Error ? error_9.message : String(error_9) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
// =============================================
router.post('/signature/generate', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, signature, style, baseResult, variationsResult, exportResult;
    return __generator(this, function (_b) {
        try {
            _a = req.body, signature = _a.signature, style = _a.style;
            if (!signature || !style) {
                return [2 /*return*/, res.status(400).json({ error: 'Champs "signature" et "style" requis.' })];
            }
            baseResult = signatureBaseGenerator.generate(signature, style);
            variationsResult = signatureVariationsGenerator.generate(style, baseResult.palette);
            exportResult = signatureSVGExporter.export(signature.nom || 'signature', baseResult, variationsResult);
            return [2 /*return*/, res.json({
            ...
            return [2 /*return*/, res.status(500).json({ error: err.message || 'Erreur interne' })];
        }
        return [2 /*return*/];
    });
}); });
