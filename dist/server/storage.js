...
var MemStorage = /** @class */ (function () {
    ...
    MemStorage.prototype.initializeData = function () {
        ...
        sampleEffects.forEach(function (effect) {
            var id = randomUUID();
            var newEffect = __assign(__assign({}, effect), { id: id, complexity: effect.complexity || 5, performance: effect.performance || 'medium', version: effect.version || '1.0.0', tags: effect.tags || [], rating: effect.rating || 0, downloads: effect.downloads || 0, createdAt: new Date() });
            _this.effects.set(id, newEffect);
        });
    };
    // User methods
    ...
    MemStorage.prototype.createEffect = function (insertEffect) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                id = randomUUID();
                newEffect = __assign(__assign({}, insertEffect), { id: id, complexity: insertEffect.complexity || 5, performance: insertEffect.performance || 'medium', version: insertEffect.version || '1.0.0', tags: insertEffect.tags || [], rating: insertEffect.rating || 0, downloads: insertEffect.downloads || 0, createdAt: new Date() });
                this.effects.set(id, newEffect);
                return [2 /*return*/, newEffect];
            });
        });
    };
    ...
    MemStorage.prototype.getJobs = function (status) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, jobs.sort(function (a, b) { var _a, _b; return (((_a = b.createdAt) === null || _a === void 0 ? void 0 : _a.getTime()) || 0) - (((_b = a.createdAt) === null || _b === void 0 ? void 0 : _b.getTime()) || 0); })];
            });
        });
    };
    MemStorage.prototype.createJob = function (insertJob) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                id = randomUUID();
                job = __assign(__assign({}, insertJob), { id: id, status: 'queued', progress: 0, result: null, error: null, estimatedTime: insertJob.estimatedTime || null, actualTime: null, createdAt: new Date(), completedAt: null });
    ...
    MemStorage.prototype.getUploads = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Array.from(this.uploads.values()).sort(function (a, b) { var _a, _b; return (((_a = b.createdAt) === null || _a === void 0 ? void 0 : _a.getTime()) || 0) - (((_b = a.createdAt) === null || _b === void 0 ? void 0 : _b.getTime()) || 0); })];
            });
        });
    };
