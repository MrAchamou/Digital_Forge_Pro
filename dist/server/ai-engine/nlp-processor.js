...
var AdvancedNLPProcessor = /** @class */ (function () {
    ...
    AdvancedNLPProcessor.prototype.calculateContextualRelevance = function (text, conceptName) {
        ...
        var endPos = Math.min(text.length, conceptPosition + contextWindow);
    ...
    AdvancedNLPProcessor.prototype.processPrompt = function (prompt_1) {
        return __awaiter(this, arguments, void 0, function (prompt, context) {
            var concepts, analysis, error_1;
            if (context === void 0) { context = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.extractConcepts(prompt)];
                    case 1:
                        concepts = _a.sent();
                        return [4 /*yield*/, this.analyzeIntent(prompt)];
                    case 2:
                        analysis = _a.sent();
                        return [2 /*return*/, {
                                concepts: concepts.map(function (concept) { return ({
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error("Error processing prompt:", error_1); // Added console logging for errors
                        return [2 /*return*/, {
                                concepts: [],
                                intent: 'unknown',
                                confidence: 0.1,
                                error: error_1 instanceof Error ? error_1.message : 'Processing failed'
                            }];
    ...
    AdvancedNLPProcessor.prototype.analyzeIntent = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Placeholder for actual intent analysis logic
                if (text.includes("help") || text.includes("assist")) {
                    return [2 /*return*/, { intent: "seeking_help", confidence: 0.7 }];
                }
                else if (text.includes("buy") || text.includes("purchase")) {
                    return [2 /*return*/, { intent: "transaction", confidence: 0.8 }];
                }
                else if (text.includes("information") || text.includes("details")) {
                    return [2 /*return*/, { intent: "information_request", confidence: 0.75 }];
                }
                return [2 /*return*/, { intent: "general", confidence: 0.6 }];
            });
        });
    };
    AdvancedNLPProcessor.prototype.processText = function (text, context) {
        return __awaiter(this, void 0, void 0, function () {
            var concepts, intentAnalysis;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.extractConcepts(text)];
                    case 1:
                        concepts = _a.sent();
                        return [4 /*yield*/, this.analyzeIntent(text)];
                    case 2:
                        intentAnalysis = _a.sent();
                        return [2 /*return*/, {
                                concepts: concepts.map(function (c) { return ({ name: c.name, confidence: c.confidence }); }),
