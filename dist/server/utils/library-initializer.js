...
class LibraryInitializer {
    ...
    async createCategory(categoryName) {
        ...
        await fs.writeFile(path.join(categoryPath, 'category-index.json'), JSON.stringify(categoryIndex, null, 2));
    ...
    async updateCategoryIndex(categoryName, effect) {
    ...
    async createGlobalIndex(categories) {
        const globalIndex = {
        ...
        await fs.writeFile(path.join(this.libraryPath, 'global-index.json'), JSON.stringify(globalIndex, null, 2));
    }
    async createSearchIndexes() {
        ...
        await fs.writeFile(path.join(this.libraryPath, 'search-indexes.json'), JSON.stringify(searchIndexes, null, 2));
    }
    getChronobreakCode() {
